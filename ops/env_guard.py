#!/usr/bin/env python3
"""Industrial environment guard for quickstart check/repair flows.
...
class EnvGuard:
    ...
    def _check_cfg_disease_lists(self) -> None:
        list_paths = [
            ...
            self.ops_dir / "disease_list_day1_origin.txt",
            self.ops_dir / "disease_list_day1_dual.txt",
        ]
        optional = self.ops_dir / "disease_list_b_only.txt"
        if optional.exists():
