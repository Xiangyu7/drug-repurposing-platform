...
支持的数据源:
  - CT.gov: 临床试验数据
  - RxNorm: 药物名称标准化
  - ChEMBL: 药物-靶点关系 + 生物活性亲和力数据
  - Reactome: 通路数据
  - OpenTargets: 基因-疾病关联
  - FAERS: FDA不良事件报告
  - SIDER: FDA药物标签副作用数据 (补充FAERS)
...
from .chembl import (
    chembl_map, fetch_drug_targets, fetch_target_xrefs,
    target_to_ensembl, fetch_drug_target_affinities,
)
